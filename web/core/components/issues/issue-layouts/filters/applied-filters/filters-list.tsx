...
const additionalFilters = ["hub_code", "customer_code", "customer_category", "reference_number", "trip_reference_number", "vendor_code", "worker_code", "hub_name", "customer_name", "vendor_name", "worker_name", "business_type"];
