...
type TIssueTargetDateTimeActivity = { activityId: string; showIssue?: boolean; ends: "top" | "bottom" | undefined };

export const IssueTargetDateTimeActivity: FC<TIssueTargetDateTimeActivity> = observer((props) => {
