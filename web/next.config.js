    ...
    return [
      {
        ...
        headers: [
          { key: "X-Frame-Options", value: "ALLOWALL" },
          {
            ...
            value: "frame-ancestors 'self' https://*.shipsy.io http://*.shipsy.io http://*.localhost:3000 http://*.localhost:30542 http://*.localhost:3001 http://*.localhost:3002 http://5.223.42.156:3000/"
           },
          // {
          //   key: "Referrer-Policy",
